...
! function(i) {
	...
	(e = function() {
		...
		if (1 === i.options.slidesToShow && !0 === i.options.adaptiveHeight && !1 === i.options.vertical) {
			if(eheight) {
				var e = i.$slides.eq(i.currentSlide).outerHeight(!0) + 25;
			} else {
...
$('.component__plus').click(function(){
...
$(document).on('click', '.menu a', function (event) {
    ...
    if ($thisHref) {
        $('html, body').animate({
            scrollTop: $($thisHref).offset().top -29
        }, 1000);
    }
});
